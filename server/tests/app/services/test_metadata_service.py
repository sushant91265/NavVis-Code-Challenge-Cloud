...
from server.app.services.metadata_service import MetadataService
...
class TestMetadataService(unittest.TestCase):
    ...
    @patch('server.app.services.metadata_service.MetadataService.delete')
